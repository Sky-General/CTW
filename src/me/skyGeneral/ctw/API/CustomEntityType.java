...
public enum CustomEntityType {
	...
	REDSHEEP("RedSheep", EntityType.SHEEP.getTypeId(), EntityType.SHEEP, EntitySheep.class, RedSheep.class),
	BLUESHEEP("BlueSheep", EntityType.SHEEP.getTypeId(), EntityType.SHEEP, EntitySheep.class, BlueSheep.class);
